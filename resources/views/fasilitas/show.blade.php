			  ...
			  <div class="panel-body">
        			<div class="form-group {{ $errors->has('nama') ? ' has-error' : '' }}">
			  		...
			  		<div class="form-group {{ $errors->has('keterangan') ? ' has-error' : '' }}">
			  			...
			  			<input type="text" name="keterangan" class="form-control" value="{{ $fasilitas
			  			->keterangan }}" readonly>
			  		...
			  		<div class="form-group {{ $errors->has('id_jurusan') ? ' has-error' : '' }}">
						...
						<input type="text" name="id_jurusan" class="form-control" value="{{ $fasilitas->jurusan->nama }}"  readonly>
